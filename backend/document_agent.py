...
DOCUMENT_PATTERNS = {
    ...
    # "secondary" alone means Class 10, but must NOT fire on "higher/senior secondary" (Class 12)
    r"\b10th\b|\bssc\b|(?<!higher )(?<!senior )\bsecondary\b": "10th Certificate & Marksheet",
    r"\b12th\b|\bhsc\b|(?:higher|senior)\s*secondary": "12th Certificate & Marksheet",
    ...
    r"\bpan\s*card\b|\bpan\b": "PAN Card",
